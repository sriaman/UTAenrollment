...
@app.route("/user")
def user():
    #User(user_id=1,first_name="Aman",last_name="Srivastav",email="amancs18997@gmail.com",password="1234567890").save()    
    #User(user_id=2,first_name="Saket",last_name="Srivastav",email="saket744@gmail.com",password="1234567890").save()
